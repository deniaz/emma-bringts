...
const styles = {
  container: 'mb-8 px-8 py-10 bg-white rounded-lg md:grid md:grid-cols-3 md:gap-4 box-border',
...
export const ResultItem: FC<Props> = ({ name, body, categories, hours, address, services, contact }) => (
